...
def test_check_include_resources_invalid():
    ...
    assert (
        "--include-resources argument should contain a subset of [autoscalingrunnersets, cronjobs, daemonsets, deployments, horizontalpodautoscalers, jobs, kafkaconnects, poddisruptionbudgets, rollouts, scaledobjects, stacks, statefulsets]"
